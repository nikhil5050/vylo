...
fbq('track', 'PageView');`}
  ...
  y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);
    })(window, document, "clarity", "script", "ye4k1p1sau");`}
  </Script>
        <noscript>
          <iframe
          ...
          />
          {/* Meta's noscript fallback requires a plain tracking image. */}
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            height="1"
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1035289126003863&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
