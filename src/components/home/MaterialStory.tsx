...
const materialDetails: Feature[] = [
  ...
  {
    id: "silver-base",
    label: "Made to Matter",
    detail: "Thoughtfully created with details that bring lasting meaning",
    side: "left",
  ...
  },
  {
    ...
    detail: "Every curve and finish is considered to feel distinctive and refined",
    side: "left",
  ...
  },
  {
    ...
    detail: "Easy to wear, effortless to style and designed for every day",
    side: "left",
  ...
  // Right Side Features -> Connecting to Ring parts
  {
    ...
    detail: "Contemporary pieces made to be cherished season after season",
    side: "right",
    textStyle: "top-[15%] right-[3%] lg:right-[4%]",
    textPoint: { x: 74, y: 18 },
    targetPoint: { x: 54, y: 25 },
  ...
  },
  {
    ...
    detail: "Versatile silhouettes that move naturally from one moment to the next",
    side: "right",
  ...
  {
    id: "made-to-last",
    label: "Meaningful Design",
    detail: "Jewellery with a quiet point of view and a story worth wearing",
    side: "right",
